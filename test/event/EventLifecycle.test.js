...
describe("Feature 5 lifecycle transitions", () => {
    ...
    function makeRsvpRepo() {
        const repo = {
            countGoing: async () => (0, result_1.Ok)(0),
        };
        return repo;
    }
    ...
    test("organizer can publish a draft event", async () => {
        const repo = (0, InMemoryEventRepository_1.CreateInMemoryEventRepository)();
        const service = (0, EventService_1.CreateEventService)(repo, makeRsvpRepo());
