...
const EventService_1 = require("../../src/event/EventService");
...
async function seedPublishedEvent(repo, overrides = {}) {
...
describe("EventService.updateEvent", () => {
    ...
    let service;
    beforeEach(() => {
        repo = (0, InMemoryEventRepository_1.CreateInMemoryEventRepository)();
        const rsvpRepo = (0, InMemoryRsvpRepository_1.CreateInMemoryRsvpRepository)();
        service = (0, EventService_1.CreateEventService)(repo, rsvpRepo);
    });
